...
module walllist_mod
    ...
    type, extends(sublist_t) :: walllist_t

    contains
        procedure :: init01_sublist => init01_walllist
    end type

    contains
    ! Both stream and collision are initialized by default.
    subroutine init01_walllist(this,mlist,istinmlist,indinmlist,ist)
        class(walllist_t),target :: this
